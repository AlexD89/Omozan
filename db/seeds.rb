...
ipsum_desc = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Lobortis elementum nibh tellus molestie nunc non. Vitae tortor condimentum lacinia quis vel eros donec ac. Tempor id eu nisl nunc mi. Nibh cras pulvinar mattis nunc sed blandit libero. Risus sed vulputate odio ut enim. Sit amet volutpat consequat mauris nunc congue nisi vitae suscipit. Enim nec dui nunc mattis enim. Faucibus et molestie ac feugiat sed lectus vestibulum. Ut etiam sit amet nisl purus in mollis nunc. /////

Ultricies leo integer malesuada nunc vel risus commodo viverra maecenas. Et sollicitudin ac orci phasellus egestas tellus rutrum tellus. Ultrices dui sapien eget mi proin. Metus vulputate eu scelerisque felis imperdiet proin fermentum leo vel. Sed egestas egestas fringilla phasellus faucibus scelerisque. Pretium vulputate sapien nec sagittis aliquam. Sed velit dignissim sodales ut eu sem integer vitae justo. Id velit ut tortor pretium viverra suspendisse potenti. Et malesuada fames ac turpis egestas integer eget. Mattis vulputate enim nulla aliquet. /////

Dignissim diam quis enim lobortis. Sit amet tellus cras adipiscing enim. Fringilla urna porttitor rhoncus dolor. Ultricies integer quis auctor elit. Venenatis a condimentum vitae sapien pellentesque habitant morbi. Feugiat scelerisque varius morbi enim. Mauris sit amet massa vitae tortor condimentum lacinia quis vel. Pharetra diam sit amet nisl suscipit adipiscing bibendum est ultricies. Quam vulputate dignissim suspendisse in est ante. Euismod elementum nisi quis eleifend quam adipiscing. ///// 
Platea dictumst vestibulum rhoncus est pellentesque elit ullamcorper. Blandit cursus risus at ultrices mi tempus imperdiet nulla malesuada. Egestas congue quisque egestas diam in arcu cursus euismod. Consequat semper viverra nam libero justo. Ac tortor vitae purus faucibus ornare suspendisse sed. Porttitor lacus luctus accumsan tortor posuere. Sit amet est placerat in. Nunc mi ipsum faucibus vitae aliquet. Sed sed risus pretium quam. Mauris sit amet massa vitae tortor condimentum lacinia quis vel."
...
def assign_dep(dep, arr_of_prod)
    arr_of_prod.each do |product|
        DepartmentItem.create!(product_id: product.id, department_id: dep.id)
    end
end
...
file11 = URI.open('https://omozan-seeds.s3.amazonaws.com/tyboatle.jpg')
tyboatle_sofa.image.attach(io: file11, filename: "tyboatle.jpg")
...
file42 = URI.open('https://omozan-seeds.s3.amazonaws.com/rachael_ray.jpg')
rechael_ray.image.attach(io: file42, filename: "rachael_ray.jpg")
...
file46 = URI.open('https://omozan-seeds.s3.amazonaws.com/henckels.jpg')
henkels.image.attach(io: file46, filename: "henckels.jpg")
file47 = URI.open('https://omozan-seeds.s3.amazonaws.com/homevss.jpg')
home_vss.image.attach(io: file47, filename: "homevss.jpg")
